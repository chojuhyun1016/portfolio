...
*             _iCDt   : 읽어들일 데이터의 Row 개수                             *
*             _fpFile : 데이터를 읽어들일 파일의 파일포인터                    *
*                                                                              *
* Return    : int, 성공(읽어들인 개수), 실패(0)                                *
* Stability : MT-Safe                                                          *
* Explain   : 파일(_fpFile)로부터 _iSize크기의 데이터를 _iCDt개수 만큼 읽어들여*
*             버퍼(_vpBuf)에 저장한다.                                         *
*             시그널에의해 인터럽트 되었을 경우 루프를 돌면서 _iCDt개수만큼    *
...
*             _iCDt   : 출력 할 데이터의 Row 개수                              *
*             _fpFile : 데이터를 출력 할 파일의 파일포인터                     *
*                                                                              *
* Return    : int, 성공(읽어들인 개수), 실패(EOF)                              *
* Stability : MT-Safe                                                          *
* Explain   : 버퍼(_vpBuf)의 _iSize크기의 데이터를 _iCDt 개수만큼              *
*             파일(_fpFile)에 출력한다.                                        *
*             시그널에의해 인터럽트 되었을 경우 루프를 돌면서 _iCDt개수만큼    *
