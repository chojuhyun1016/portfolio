...
public class Const
{
	...
	public static interface Q_BACKUP_RETRY_PM_MSG_FROM_DATE
	{
		public final static String STRUCTURE_NAME	= "Q_BACKUP_RETRY_PM_MSG_FROM_DATE";
		public final static String STRUCTURE_DESC	= "";
	}

	public static interface Q_BACKUP_RETRY_MP_DCMNT_INFO_FROM_DATE
	{
		public final static String STRUCTURE_NAME	= "Q_BACKUP_RETRY_MP_DCMNT_INFO_FROM_DATE";
		public final static String STRUCTURE_DESC	= "";
	}

	public static interface Q_BACKUP_RETRY_PM_REMIND_MSG_FROM_DATE
	{
		public final static String STRUCTURE_NAME	= "Q_BACKUP_RETRY_PM_REMIND_MSG_FROM_DATE";
		public final static String STRUCTURE_DESC	= "";
	}
	...
	public static interface DOCUMENT
	{
		public static interface ISSUE
		{
			...
			{
				public final static Code<String> SUCCESS = Code.<String>builder().val("S").desc("발급 상태 (안료)").build();
				public final static Code<String> ERROR = Code.<String>builder().val("E").desc("발급 상태 (에러)").build();
				public final static Code<String> FAIL = Code.<String>builder().val("F").desc("발급 상태 (거부)").build();
				public final static Code<String> WAIT = Code.<String>builder().val("W").desc("발급 상태 (대기)").build();
			}
		}
	...
	public static interface FORMATTER
	{
		...
		public final static Code<SimpleDateFormat> yyyyMM = Code.<SimpleDateFormat>builder()
				.val(new SimpleDateFormat("yyyyMM")).desc("날짜 포맷터 yyyyMM").build();

		public final static Code<SimpleDateFormat> yyyy = Code.<SimpleDateFormat>builder()
				.val(new SimpleDateFormat("yyyy")).desc("날짜 포맷터 yyyy").build();

		public final static Code<SimpleDateFormat> MM = Code.<SimpleDateFormat>builder()
				.val(new SimpleDateFormat("MM")).desc("날짜 포맷터 MM").build();

		public final static Code<SimpleDateFormat> dd = Code.<SimpleDateFormat>builder()
				.val(new SimpleDateFormat("dd")).desc("날짜 포맷터 dd").build();
