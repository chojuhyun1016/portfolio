...
//        	}
            encryptKey = "/9ZzF2ux1Csyn2L8ydcXkeHTGjGE4sKX2IMhHcph9NQ=";
           	encryptIv  = "2F395A7A46327578";
  //             log.info("AKey = {}, AKeyIv = {}", encryptKey,encryptIv );
        }
	...
	// 해시키 생성 (SHA 512 암호화 -> Base64 인코딩) - 기존방식
	public static String generateHashkey(String ci, String phone) throws NoSuchAlgorithmException
	{
		return new SHA(512).encryptToBase64(ci + phone);
	}
