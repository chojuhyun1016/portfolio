...
/**
 * @Class Name : RegisterEaddrResponse.java
 * @Description : 공인전자주소 등록 응답 (From. KISA)
 * 
 * @author 조주현
 * @since 2022.03.17
 * @version 1.0
...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "공인전자주소 등록", description = "공인전자주소 등록 응답 (From. KISA)")
public class RegisterEaddrResponse
{
