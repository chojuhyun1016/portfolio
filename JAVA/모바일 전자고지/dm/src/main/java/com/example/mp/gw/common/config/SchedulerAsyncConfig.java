...
public class SchedulerAsyncConfig extends AsyncConfigurerSupport
{
	...
	{
		ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
		executor.setThreadNamePrefix("bc-snd-rpt-pool-");
		executor.setCorePoolSize(2); 
		executor.setMaxPoolSize(4); 
		executor.setQueueCapacity(0); 
		executor.setRejectedExecutionHandler(new ThreadPoolExecutor.DiscardPolicy());
	...
	{
		ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
		executor.setThreadNamePrefix("bc-rsv-rpt-pool-");
		executor.setCorePoolSize(2); 
		executor.setMaxPoolSize(4); 
		executor.setQueueCapacity(0); 
		executor.setRejectedExecutionHandler(new ThreadPoolExecutor.DiscardPolicy());
	...
	@Bean("bcSendRmdSndRptPool")
	public Executor bcSendRmdSndRptPool()
	{
		ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
		executor.setThreadNamePrefix("bc-rmd-snd-rpt-pool-");
	...
	@Bean("bcSendRmdRsvRptPool")
	public Executor bcSendRmdRsvRptPool()
	{
		ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
		executor.setThreadNamePrefix("bc-rmd-rsv-rpt-pool-");
		executor.setCorePoolSize(1); 
		executor.setMaxPoolSize(2); 
		executor.setQueueCapacity(0); 
		executor.setRejectedExecutionHandler(new ThreadPoolExecutor.DiscardPolicy());
