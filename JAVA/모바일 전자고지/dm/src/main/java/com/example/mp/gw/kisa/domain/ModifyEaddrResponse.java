...
/**
 * @Class Name : ModifyEaddrResponse.java
 * @Description : 공인전자주소 소유자정보 수정 응답 (From. KISA)
 * 
 * @author 조주현
 * @since 2022.03.17
 * @version 1.0
...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "공인전자주소 소유자정보 수정", description = "공인전자주소 소유자정보 수정 응답 (From. KISA)")
public class ModifyEaddrResponse
{
