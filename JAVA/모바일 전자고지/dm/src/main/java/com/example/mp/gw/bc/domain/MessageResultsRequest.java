 ...
 * @Description : 발송/수신 결과 조회 전송 (To. 비즈센터)
 * 
 * @author 조주현
 * @since 2021.07.07
 * @version 1.0
...
@Builder
@ToString
@ApiModel(value = "발송/수신 결과 조회", description = "발송/수신 결과 조회 전송 (To. 비즈센터)")
public class MessageResultsRequest
{
	...
	private List<MessageResult> reqs;
}
