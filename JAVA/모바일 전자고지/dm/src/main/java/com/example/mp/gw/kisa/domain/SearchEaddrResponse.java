...
/**
 * @Class Name : SearchEaddrResponse.java
 * @Description : 공인전자주소 조회 응답 (From. KISA)
 * 
 * @author 조주현
 * @since 2022.03.12
 * @version 1.0
...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "공인전자주소 조회 응답", description = "공인전자주소 조회 응답 (From. KISA)")
public class SearchEaddrResponse
{
