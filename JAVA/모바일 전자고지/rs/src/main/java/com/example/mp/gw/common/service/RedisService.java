...
import com.example.mp.gw.ms.exception.FailConnectToRedisException;
...
public class RedisService<K, V>
{
	...
	public void hmsetObj(K hashKey, K key,byte[] value)
	{ 
		if (!isConnected())
			throw new FailConnectToRedisException();
		
		redisMapper.hmsetObj(hashKey, key, value);
	}	
