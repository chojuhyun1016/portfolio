...
import com.example.mp.gw.common.utils.enc.AES256Cipher;
...
public class NcasUtil
{
	...
	public static String getCi (String phone)
	{
		...
		try
		{
			...
			if (null != map.get("REAL_IPIN_CI"))
			{
				ipinCi = map.get("REAL_IPIN_CI").toString();
			}

			log.debug("===============================================================================");			
			log.debug("===========================> ipinCi :" + ipinCi);
			log.debug("===============================================================================");
		}
		catch (Exception e)
		{
	...
	public static List<String> getPhoneList (String ci)
	{
		...
		try
		{
			...
			if (null != map.get("CUST_STTS_LIST") && !"".equals(map.get("CUST_STTS_LIST")))
			{
				String tmpPhone = "";
				String tmpFirstNo = "";
