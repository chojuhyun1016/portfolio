...
/**
 * @Class Name : VerifyReadTokenResponse.java
 * @Description : (토큰인증)열람확인결과 처리 응답 (To. 비즈센터)
 * 
 * @author 조주현
 * @since 2021.07.01
 * @version 1.0
...
@ApiModel(value = "(토큰인증)열람확인결과 처리", description = "(토큰인증)열람확인결과 처리 응답 (To. 비즈센터)")
public class VerifyReadTokenResponse extends ApiResponseResult
{
