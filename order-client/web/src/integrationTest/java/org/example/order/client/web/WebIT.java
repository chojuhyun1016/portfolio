 ...
 * - WebService 호출 → JSON 응답 검증
 * - 자동구성(WebAutoConfiguration)만 로드
 */
@SpringBootTest
...
class WebIT {
    ...
    @Test
    @DisplayName("WebService → GET 호출/응답 JSON 파싱")
    void callLocalJsonEndpoint() {
        ...
        Map<String, Object> res = (Map<String, Object>) webService.get(url, null, params, Map.class);
