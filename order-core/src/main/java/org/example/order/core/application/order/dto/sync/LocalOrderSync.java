...
public record LocalOrderSync(
     ...
     */
    public LocalOrderSync withCreatedMeta(Long userId, String userType, LocalDateTime datetime) {
     ...
     */
    public LocalOrderSync withModifiedMeta(Long userId, String userType, LocalDateTime datetime) {
        return new LocalOrderSync(
                this.id,
                this.userId,
                this.userNumber,
     ...
     */
    public LocalOrderSync withFailure() {
     ...
     */
    public LocalOrderSync withPublishedTimestamp(Long newTs) {
        return new LocalOrderSync(
                this.id,
                this.userId,
                this.userNumber,
     ...
     * 필요 시 추가 정의해서 쓰세요.
     */
    public LocalOrderSync withOrderNumber(String newOrderNumber) {
        return new LocalOrderSync(
                this.id,
                this.userId,
                this.userNumber,
    ...
    public LocalOrderSync withOrderPrice(Long newOrderPrice) {
        return new LocalOrderSync(
                this.id,
                this.userId,
                this.userNumber,
    ...
    public LocalOrderSync withVersion(Long newVersion) {
        return new LocalOrderSync(
                this.id,
                this.userId,
                this.userNumber,
